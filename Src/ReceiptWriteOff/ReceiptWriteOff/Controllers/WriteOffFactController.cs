    ...
    : ControllerBase
{
    ...
    public async Task<ActionResult<WriteOffFactResponse>> RegisterAsync([FromBody] RegisterWriteOffFactRequest request,
    ...
    public async Task<IActionResult> EditAsync(int id,
        [FromBody] RegisterWriteOffFactRequest request,
        CancellationToken cancellationToken)
    {
        try
        {
